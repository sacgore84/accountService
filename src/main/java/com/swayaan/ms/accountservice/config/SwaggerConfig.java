package com.swayaan.ms.accountservice.config;
...
public class SwaggerConfig {
	  ...
	  public static final Contact DEFAULT_CONTACT = new Contact( "sachin Gore",
	  "http://www.aurionpro.com", "sachin.gore@aurionpro.com");
